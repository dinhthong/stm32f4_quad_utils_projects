...
uint16_t readRegister16(uint8_t reg)
{
  ...
  I2C_Send7bitAddress(I2C2, MS5611_ADDRESS, I2C_Direction_Transmitter);
  ...
  I2C_Send7bitAddress(I2C2, MS5611_ADDRESS, I2C_Direction_Receiver);
