...
//#define DELAY_IIC 2
//IO方向设置
#define SDA2_IN()  {GPIOE->MODER&=0xFFFF3FFF;GPIOE->MODER|=0x00000000;}
#define SDA2_OUT() {GPIOE->MODER&=0xFFFF3FFF;GPIOE->MODER|=0x00004000;}


//IO操作函数
#define IIC2_SCL    PBout(1) //SCL
#define IIC2_SDA    PEout(7) //SDA	 
#define READ2_SDA   PEin(7)  //输入SDA 
