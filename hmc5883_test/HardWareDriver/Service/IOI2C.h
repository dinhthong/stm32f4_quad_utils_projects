...
// this need correction
#define SDA4_IN()  {GPIOA->MODER&=0xFFFFFF3F;GPIOA->MODER|=0x00000000;}
#define SDA4_OUT() {GPIOA->MODER&=0xFFFFFF3F;GPIOA->MODER|=0x00000040;}


//IO操作函数
#define IIC4_SCL    PAout(2) //SCL
#define IIC4_SDA    PAout(3) //SDA	 
#define READ4_SDA   PAin(3)  //输入SDA 
...
u8 IIC4_Wait_Ack(void); 				//IIC2等待ACK信号
void IIC4_Ack(void);					//IIC2发送ACK信号
void IIC4_NAck(void);				//IIC2不发送ACK信号

extern int16_t  I2C4_Erorr_Count;
